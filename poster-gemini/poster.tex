...
\usepackage{lmodern}
%DEFAULT: \usepackage[size=custom, width=122,height=91, scale=1.2]{beamerposter}
\usepackage[size=custom, width=106,height=80, scale=1]{beamerposter}
\usetheme{gemini}
...
\institute[UW--Madison]{Department of Statistics, University of Wisconsin--Madison}
